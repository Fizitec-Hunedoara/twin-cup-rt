 ...
 */
public class test_odom extends OpMode {
...
//                }
    ...
    public void loop() {
        ...
        telemetry.addData("poz odometru spate", motorFL.getCurrentPosition());
        telemetry.addData("poz odometru stanga", motorBL.getCurrentPosition());
        telemetry.addData("poz odometru dreapta", motorFR.getCurrentPosition());
